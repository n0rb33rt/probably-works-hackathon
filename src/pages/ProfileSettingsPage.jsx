  ...
  return (
    <div className="font-OutFit">
      ...
      <Form method="POST">
        ...
        <button className="mt-10 bg-[#1A30A6] text-white text-[12px] font-semibold h-[60px] text-center py-5 rounded-[60px] w-full">
          Зберегти
        </button>
      </Form>
    </div>
...
export async function action({ request }) {
  ...
  if (!response.ok) {
    return json({ message: "Couldn't fetch the data" });
  }
